...
public class AvailableCars extends AnchorPane {
    ...
    public void prepareFields() {
        ...
        ObservableList<rental.client.OneAvailableCar> items = FXCollections.observableArrayList();
        ...
        try (Connection conn = ConnectionDB.connect();
            ...
            while (rs.next()) {
                rental.client.OneAvailableCar oac = new rental.client.OneAvailableCar();
